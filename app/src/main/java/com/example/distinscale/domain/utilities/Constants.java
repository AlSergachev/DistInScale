...
public class Constants {
    ...
    public static final List<String> listOfSteps = Arrays.asList(
            "Загрузка...", "Изображение загружено...", "Фильтрация Pyrmeanshift выполнена...",
            "Бинаризация изображения выполнена...", "Углы листа получены...",
            "Углы листа отсортированы...", "Трансформирование выполненно...",
            "Изображение обрезано...", "Фильтрация Pyrmeanshift выполнена...",
            "Бинаризация изображения выполнена...", "Точки найденны...",
            "Стрелка нарисована...", "Обработка завершена!"
    );
}
